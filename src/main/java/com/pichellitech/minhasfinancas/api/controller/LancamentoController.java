package com.pichellitech.minhasfinancas.api.controller;


import com.pichellitech.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.pichellitech.minhasfinancas.api.dto.LancamentoDTO;
...
import com.pichellitech.minhasfinancas.service.LancamentoService;
...
public class LancamentoController {
    ...
    public ResponseEntity buscar(@RequestParam(value = "descricao", required = false) String descricao,
        ...
        if (usuario.isEmpty()){
            return ResponseEntity.badRequest().body("Não foi possível realizar a consulta. Id do usuário não encontrado");
        }else {
    ...
    public ResponseEntity atualizarStatus(@PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto){
        return service.obterPorId(id).map( entity -> {
            ...
            if (statusSelecionado == null) {
                return ResponseEntity.badRequest().body("Não foi possível atualizar o status, passe um status válido.");
            }
